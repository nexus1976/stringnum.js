...
var StringNum = /** @class */ (function () {
    ...
    ;
    StringNum.prototype.splitNumStringByPlaces = function (str) {
        var result = [];
        var placeCounter = 0;
        var placeResult = '';
    ...
    ;
    StringNum.prototype.wordize = function (str) {
        var result = '';
        if (str.length === 3) {
    ...
    StringNum.prototype.toWords = function (num, formatFinancial) {
        ...
        var myword = '';
        var wordPlaces = this.splitNumStringByPlaces(wordNum);
        for (var i = wordPlaces.length; i > 0; i--) {
            var wordPart = this.wordize(wordPlaces[i - 1]);
